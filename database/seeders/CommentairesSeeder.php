...
class CommentairesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('comments')->insert([
            [
                'article_id' => 12, // ID d'un article existant
                'auteur' => 'Jean Dupont',
            ...
            [
                'article_id' => 13, // ID d'un autre article existant
                'auteur' => 'Marie Martin',
            ...
            [
                'article_id' => 14, // Vous pouvez ajouter plusieurs commentaires pour le même article
                'auteur' => 'Aliou Diop',
